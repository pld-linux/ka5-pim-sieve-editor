...
# Source0-md5:	4584142cdef39037f8fc6c68ab132caf
...
Sieve Editor jest edytorem skryptów Sieve wykorzystywanych do
filtrowania poczty na serwerach pocztowych.
...
%ghost %{_libdir}/libsieveeditor.so.6
%attr(755,root,root) %{_libdir}/libsieveeditor.so.*.*
...
%{_iconsdir}/hicolor/*x*/apps/sieveeditor.png
%{_iconsdir}/hicolor/scalable/apps/sieveeditor.svg
